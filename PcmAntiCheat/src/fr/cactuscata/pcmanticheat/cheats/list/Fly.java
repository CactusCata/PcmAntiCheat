...
public class Fly implements ICheat {
	...
	public ItemStack getItemStack() {
		return new ItemBuilder(Material.FEATHER, getAlertNumber() > 64 ? 64 : getAlertNumber()).setDisplayName("Fly :")
				.setGlowing(getAlertNumber() != 0).setLore(this.warnList).build();
	}
